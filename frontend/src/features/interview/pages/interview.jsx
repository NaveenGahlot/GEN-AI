...
const Interview = () => {
    ...
    const scoreValue = typeof report.matchScore === 'number' ? report.matchScore : 0
    const scoreColor =
        scoreValue >= 80 ? 'score--high' :
            scoreValue >= 60 ? 'score--mid' : 'score--low'
    ...
    const preparationPlan = Array.isArray(report.preprationPlan) ? report.preprationPlan : []
